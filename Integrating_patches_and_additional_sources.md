...
Contents
1.  [**1** Why use a custom plist?](patchfiles.html#TOC-Why-use-a-custom-plist-)
    1.  [**1.1** Editing plists](patchfiles.html#TOC-Editing-plists)
2.  [**2** Sample custom plist](patchfiles.html#TOC-Sample-custom-plist)
3.  [**3** File name conventions](patchfiles.html#TOC-File-name-conventions)
...
-   If you have a <span style="font-weight:bold">source tarball</span>, it should be named projectname-version.tar.gz
     ...
     Example: <span style="font-family:courier new,monospace"><span style="font-size:small">ACPIPS2Nub-1.tar.gz</span></span>
-   If you have a <span style="font-weight:bold">patch</span>, it should be named with the name, a dash, version, followed by .p0.patch
     Example: <span style="font-family:courier new,monospace"><span style="font-size:small">boot-132_dfe_r122.p0.patch</span></span>
-   If you have a <span style="font-weight:bold">set of patches</span> for a given project, make a tarball named project-version-patches.tar.gz, which extracts to project-version-patches.  DarwinBuild will then apply each of the patches in that directory.
     Example: <span style="font-family:courier new;font-size:12px">boot-132-patches.tar.gz</span>
