...
Contents
 * [**1** Prerequisites](darwinbuild.html#TOC-Prerequisites)  
 * [**2** Terminology](darwinbuild.html#TOC-Terminology)  
 * [**3** Installation](darwinbuild.html#TOC-Installation)  
     * [**3.1** From SVN](darwinbuild.html#TOC-From-SVN)  
         * [**3.1.1** Darwin 10](darwinbuild.html#TOC-Darwin-10)  
         * [**3.1.2** Darwin 9](darwinbuild.html#TOC-Darwin-9)  
     * [**3.2** From MacPorts](darwinbuild.html#TOC-From-MacPorts)  
 * [**4** Initialize Darwinbuild](darwinbuild.html#TOC-Initialize-Darwinbuild)  
     * [**4.1** Some part of the environment](darwinbuild.html#TOC-Some-part-of-the-environment)  
         * [**4.1.1** The BuildRoot directory](darwinbuild.html#TOC-The-BuildRoot-directory)  
         * [**4.1.2** Logs folder](darwinbuild.html#TOC-Logs-folder)  
 * [**5** Building projects](darwinbuild.html#TOC-Building-projects)  
     * [**5.1** CoreFoundation as a first test case](darwinbuild.html#TOC-CoreFoundation-as-a-first-test-case)  
     * [**5.2** xnu](darwinbuild.html#TOC-xnu)  
     * [**5.3** /XCD/loper](darwinbuild.html#TOC-XCD-loper)  
 * [**6** More cool stuff DarwinBuild can do](darwinbuild.html#TOC-More-cool-stuff-DarwinBuild-can-do)  
     * [**6.1** darwinxref](darwinbuild.html#TOC-darwinxref)  
         * [**6.1.1** Listing all the projects for a given branch](darwinbuild.html#TOC-Listing-all-the-projects-for-a-given-branch)  
         * [**6.1.2** Searching the project of a given file](darwinbuild.html#TOC-Searching-the-project-of-a-given-file)  
         * [**6.1.3** Building all the projects (brutus way)](darwinbuild.html#TOC-Building-all-the-projects-brutus-way-)  
     * [**6.2** Package the built binaries](darwinbuild.html#TOC-Package-the-built-binaries)  
 * [**7** Resources](darwinbuild.html#TOC-Resources)  
     * [**7.1** Deprecated](darwinbuild.html#TOC-Deprecated)  
         * [**7.1.1** Workaround DarwinBuild ticket #1 (no longer needed)](darwinbuild.html#TOC-Workaround-DarwinBuild-ticket-1-no-longer-needed-)  
         * [**7.1.2** Populate BuildRoot (no longer needed)](darwinbuild.html#TOC-Populate-BuildRoot-no-longer-needed-)  
     * [**7.2** Credits](darwinbuild.html#TOC-Credits)  
